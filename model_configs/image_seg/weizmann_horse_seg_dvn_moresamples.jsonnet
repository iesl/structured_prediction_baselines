...
local n_gbi_samples = std.parseJson(std.extVar('n_gbi_samples'));
local n_adv_samples = std.parseJson(std.extVar('n_adv_samples'));
    ...
    sampler: {
      ...
      constituent_samplers: [
        //GBI
        {
          ...
          number_init_samples: n_gbi_samples,
        ...
        // Adversarial
        {
          ...
          stopping_criteria: 30,
          sample_picker: { type: 'best' },
          number_init_samples: n_adv_samples,
          random_mixing_in_init: random_mixing_in_init,
        },
        // Ground Truth
        { type: 'ground-truth' },
