...

{
  ...
  model: {
    type: 'seal-weizmann-horse-seg', // multi-label-classification-with-infnet
    task_nn: task_nn,
    sampler: {
    ...
    inference_module: {
      type: 'weizmann-horse-seg-inference-net', // multi-label-inference-net-normalized
      ...
      loss_fn: {
        ...
        constituent_losses: [
          {
            type: 'weizmann-horse-seg-score-loss', //multi-label-dvn-score
            normalize_y: true,
            reduction: 'none',
            log_key: 'neg.dvn_score',
          },
          {
            type: 'weizmann-horse-seg-ce', //multi-label-bce
            reduction: 'none',
            normalize_y: false,
            log_key: 'ce',
          },
