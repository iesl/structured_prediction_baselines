...
local ff_dropout = 0.3; //std.parseJson(std.extVar('ff_dropout_10x')) / 10.0;
...
local dvn_score_loss_weight = 0.002435; //std.parseJson(std.extVar('dvn_score_loss_weight'));
{
  ...
  trainer: {
    ...
    inner_mode: 'score_nn',
    num_steps: { task_nn: 10, score_nn: 6 },
  },
}
