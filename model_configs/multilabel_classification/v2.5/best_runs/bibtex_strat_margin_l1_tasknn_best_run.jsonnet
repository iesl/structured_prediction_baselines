...
local cross_entropy_loss_weight = 3.89; //std.parseJson(std.extVar('cross_entropy_loss_weight'));
local inference_score_weight = 0.001525; //std.parseJson(std.extVar('inference_score_weight'));
{
  ...
  trainer: {
    ...
    inner_mode: 'task_nn',
    num_steps: { task_nn: 6, score_nn: 1 },
  },
}
