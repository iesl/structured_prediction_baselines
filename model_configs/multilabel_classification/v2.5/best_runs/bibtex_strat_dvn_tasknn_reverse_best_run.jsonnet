...
local ff_dropout = 0.5; //std.parseJson(std.extVar('ff_dropout_10x')) / 10.0;
...
local dvn_score_loss_weight = 8.559; //std.parseJson(std.extVar('dvn_score_loss_weight'));
{
  ...
  trainer: {
    ...
    optimizer: {
      optimizers: {
        task_nn:
          {
            lr: 0.0033614514208063573,
            weight_decay: ff_weight_decay,
            type: 'adamw',
          },
        score_nn: {
          lr: 0.0001526736963518947,
          weight_decay: ff_weight_decay,
          type: 'adamw',
        },
      },
