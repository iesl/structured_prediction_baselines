...
local cross_entropy_loss_weight = 5.603; //std.parseJson(std.extVar('cross_entropy_loss_weight'));
local inference_score_weight = 0.001177; //std.parseJson(std.extVar('inference_score_weight'));
{
