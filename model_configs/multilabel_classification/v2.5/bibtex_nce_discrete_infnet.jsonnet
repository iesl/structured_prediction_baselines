...
local inference_score_loss_weight = std.parseJson(std.extVar('inference_score_loss_weight'));
{
  ...
  model: {
    ...
    inference_module: {
      ...
      loss_fn: {
        ...
        loss_weights: [inference_score_loss_weight, cross_entropy_loss_weight],
        reduction: 'mean',
      },
    },
