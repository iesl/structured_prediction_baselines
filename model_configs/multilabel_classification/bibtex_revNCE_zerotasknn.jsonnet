...

{
  ...
  model: {
    ...
    loss_fn: { // for learning the score-NN
      type: 'multi-label-ncerev-ranking',
      reduction: 'mean',
      log_key: 'ncerev-ranking-loss',
    },
    initializer: {
      regexes: [
        [@'.*sampler.inference_nn.*', { type: "pretrained", weights_file_path: '/mnt/nfs/scratch1/jaylee/repository/structured_prediction/pretrained_taskNN_fromNCEsampler.th' }],
  ...
  trainer: {
    ...
    patience: 20,
    validation_metric: '-ncerev-ranking-loss',
