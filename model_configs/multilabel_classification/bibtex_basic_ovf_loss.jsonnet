...

{
  ...
  model: {
    ...
    oracle_value_function: { type: 'per-instance-lsef1', differentiable: true },
    loss_fn: {
      type: 'combination-loss',
      constituent_losses: [
        { type: 'multi-label-ovf', reduction: 'none', normalize_y: true },
        {
  ...
  trainer: {
    num_epochs: if test == '1' then 100 else 100,
    grad_norm: 10.0,
    patience: 8,
