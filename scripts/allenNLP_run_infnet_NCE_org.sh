...
#   --config_file=model_configs/multilabel_classification/NCE_comparison/nce10_org_config.json \
...
# wandb_allennlp --subcommand=train \
#   --config_file=model_configs/multilabel_classification/NCE_comparison/nce20_org_config.json \
#   --include-package=structured_prediction_baselines \
...
# wandb_allennlp --subcommand=train \
#   --config_file=model_configs/multilabel_classification/NCE_comparison/nce30_org_config.json \
#   --include-package=structured_prediction_baselines \
...
# wandb_allennlp --subcommand=train \
#   --config_file=model_configs/multilabel_classification/NCE_comparison/nce40_org_config.json \
#   --include-package=structured_prediction_baselines \
...
# wandb_allennlp --subcommand=train \
#   --config_file=model_configs/multilabel_classification/NCE_comparison/nce50_org_config.json \
#   --include-package=structured_prediction_baselines \
...
# wandb_allennlp --subcommand=train \
#   --config_file=model_configs/multilabel_classification/NCE_comparison/nce10_negpn_discrete.json \
#   --include-package=structured_prediction_baselines \
...
wandb_allennlp --subcommand=train \
  --config_file=model_configs/multilabel_classification/NCE_comparison/nce20_negpn_discrete.json \
  --include-package=structured_prediction_baselines \
...
# wandb_allennlp --subcommand=train \
#   --config_file=model_configs/multilabel_classification/NCE_comparison/nce30_negpn_discrete.json \
#   --include-package=structured_prediction_baselines \
...
# wandb_allennlp --subcommand=train \
#   --config_file=model_configs/multilabel_classification/NCE_comparison/nce40_negpn_discrete.json \
#   --include-package=structured_prediction_baselines \
...
# wandb_allennlp --subcommand=train \
#   --config_file=model_configs/multilabel_classification/NCE_comparison/nce50_negpn_discrete.json \
#   --include-package=structured_prediction_baselines \
