...
@TokenEmbedder.register("pretrained_transformer_adapter")
class PretrainedTransformerEmbedder(TokenEmbedder):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__()
        from allennlp.common import cached_transformer_adapters

        self.transformer_model = cached_transformer_adapters.get(
            model_name=model_name,
            adapter_task_name=adapter_task_name,
