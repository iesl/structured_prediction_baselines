local test = 0;  // a test run with small dataset
local data_dir = 'data';
local cuda_device = 0;
local use_wandb = true;
...
// model variables
local ff_hidden = 400;
local ff_dropout = 0.5;
local ff_activation = 'softplus';
local ff_linear_layers = 1;
local ff_weight_decay = 0.02363099785094907;
local global_score_hidden_dim = 200;
local gain = (if ff_activation == 'tanh' then 5 / 3 else 1);
local gbi_lr = 0.10942131291656398;
