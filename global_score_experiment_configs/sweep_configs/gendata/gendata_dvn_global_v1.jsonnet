...
local global_score_hidden_dim_1 = std.parseJson(std.extVar('global_score_hidden_dim_1'));
local global_score_hidden_dim_2 = std.parseJson(std.extVar('global_score_hidden_dim_2'));
...
local gbi_optim = 'adam';
{
  ...
  model: {
    ...
    score_nn: {
      ...
      global_score: {
        type: 'multi-label-feedforward-global-v1',
        feedforward1: {
          input_dim: num_labels,
          num_layers: global_score_num_layers,
          activations: ff_activation,
          hidden_dims: global_score_hidden_dim_1,
        },
        feedforward2: {
          input_dim: global_score_hidden_dim_1 + ff_hidden,
          num_layers: global_score_num_layers,
          activations: ff_activation,
          hidden_dims: global_score_hidden_dim_2,
        },
